      ...
      body: ListView(
        children: const [
          ...
          Card(
            ...
            leading: CircleAvatar(
              backgroundImage:
                  AssetImage("assets/images/pexels-daniel-xavier-1239291.jpg"),
            ),
            title: Text("Product3"),
          ...
          Card(
            ...
            leading: CircleAvatar(
              backgroundImage:
                  AssetImage("assets/images/pexels-stefan-stefancik-91227.jpg"),
            ),
            title: Text("Product4"),
          ...
          Card(
            ...
            leading: CircleAvatar(
              backgroundImage: AssetImage(
                  "assets/images/pexels-vinicius-wiesehofer-1130626.jpg"),
            ),
            title: Text("Product5"),
            subtitle: Text("hello"),
            trailing: Column(
